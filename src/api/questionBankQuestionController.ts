...
/** batchAddQuestionBankQuestion POST /api/questionBankQuestion/batch/add */
export async function batchAddQuestionBankQuestionUsingPost(
  body: API.QuestionBankQuestionBatchAddRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/questionBankQuestion/batch/add', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** batchRemoveQuestionBankQuestion POST /api/questionBankQuestion/batch/remove */
export async function batchRemoveQuestionBankQuestionUsingPost(
  body: API.QuestionBankQuestionBatchRemoveRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/questionBankQuestion/batch/remove', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
