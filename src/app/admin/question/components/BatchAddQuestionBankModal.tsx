...
import {
  ...
  batchAddQuestionBankQuestionUsingPost,
 ...
 * @constructor
 */
export const BatchAddQuestionBankModal: React.FC<Props> = (props) => {
   ...
   * @param fields
   */
  const doSubamit = async (fields: API.QuestionBankQuestionBatchAddRequest) => {
  ...
  return (
    ...
    >
      <Form form={form}>
        <Form.Item label={"向题库添加题目"} name="questionBankIdList">
          <Select
            style={{ width: "100%" }}
            placeholder="选择题库"
